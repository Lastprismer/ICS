...
wordsig RRAX     'REG_RAX'   	     # Special value indicating "no register"
...
word aluA = [
	E_icode == IIADDQ && E_valC == -114514 : E_valA; # 条件加，%rax
	E_icode in { IRRMOVQ, IOPQ } : E_valA;
	E_icode in { IIRMOVQ, IRMMOVQ, IMRMOVQ, IIADDQ } : E_valC; # 其他，valC
...
word aluB = [
	E_icode == IIADDQ && E_valC == -114514 : 1; # 条件加，1
	E_icode in { IRMMOVQ, IMRMOVQ, IOPQ, ICALL, 
		     IPUSHQ, IRET, IPOPQ,IIADDQ } : E_valB; # 其他，valB
...
word e_dstE = [
	E_icode == IIADDQ && E_valC == -114514 && E_valB > 0 : RRAX;
	E_icode == IIADDQ && E_valC == -114514 : RNONE; # 条件加
